...
function updateActiveNav() { const nav = document.querySelectorAll('.nav-btn'); let groupIndex = 0; if (activeIndex === 8) groupIndex = 3; else if (activeIndex >= 5 && activeIndex <= 7) groupIndex = 2; else if (activeIndex >= 2 && activeIndex <= 4) groupIndex = 1; else if (activeIndex === 1) groupIndex = 0; nav.forEach((btn, idx) => btn.classList.toggle('is-active', idx === groupIndex)); }
